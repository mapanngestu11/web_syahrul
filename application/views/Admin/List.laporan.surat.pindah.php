      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800"><span class="badge badge-primary">Laporan Permohonan Surat Pindah</span></h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="<?php echo base_url('Admin/Homepage/') ?>">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">Laporan Permohonan Surat Pindah</li>
            </ol>
          </div>
          <style type="text/css">
            .btn-cetak{
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Laporan Permohonan Surat Pindah</h6>
                  <form action="<?php echo base_url() . 'Admin/Surat_pindah/cetak_laporan'; ?>" method="POST">
                    <div class="row">
                      <div class="col-md-6">
