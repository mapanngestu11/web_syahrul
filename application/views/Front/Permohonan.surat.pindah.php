  ...
  <div class="wrapper bgded overlay" style="background-image:url('../images/demo/backgrounds/01.png');">
    <div id="breadcrumb" class="hoc clear"> 
      ...
      <ul>
        ...
        <li><a href="#">Permohonan Surat Pindah</a></li>
      </ul>
      <!-- ################################################################################################ -->
    </div>
  </div>
  ...
  <div class="wrapper row3">
    <main class="hoc container clear"> 
      ...
      <div class="content"> 
        ...
        <div class="clear btmspace-50">
          <h2>Cek Permohonan Surat Pindah</h2>
          <div class="group btmspace-50 demo">
            <form action="<?php echo base_url('Permohonan_surat_pindah/cek_permohonan') ?>" method="POST">
          ...
          <form action="<?php echo base_url('Permohonan_surat_pindah/add') ?>" method="POST"  enctype="multipart/form-data">
            <div class="row">
              <div class="col-sm-6">
