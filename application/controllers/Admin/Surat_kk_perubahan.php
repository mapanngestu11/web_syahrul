...
class Surat_kk_perubahan  extends CI_Controller
{
    ...
    {
        $data['surat'] = $this->M_surat_kk_perubahan->tampil_data();
        $this->load->view('Admin/List.surat.kk.perubahan.php', $data);
    }
    ...
    {
        $data['surat'] = $this->M_surat_kk_perubahan->tampil_data();
        $this->load->view('Admin/List.laporan.kk.perubahan.php', $data);
    }
    ...
    public function cetak_laporan ()
    {
       ...
       $data['keterangan'] = 'Permohonan Surat KK Perubahan';
       $data['laporan'] = $this->M_surat_kk_perubahan->cetak_laporan($bulan);
...
public function delete($id_kk_perubahan)
{
    $id_kk_perubahan = $this->input->post('id_kk_perubahan');
    $this->M_surat_kk_perubahan->delete_data($id_kk_perubahan);
    echo $this->session->set_flashdata('msg', 'success-hapus');
    redirect('Admin/Surat_kk_perubahan');
}
    ...
    date_default_timezone_set("Asia/Jakarta");
        ...
        if (!empty($_FILES['file_pemohon']['name'])) {
            if ($this->upload->do_upload('file_pemohon')) {
                ...
                $this->M_surat_kk_perubahan->input_data($data, 'tbl_permohonan_kk_perubahan');
    ...
    public function update()
    {
        ...
        if (!empty($_FILES['file_surat']['name'])) {
            if ($this->upload->do_upload('file_surat')) {
                ...
                $where = array(
                    'id_kk_perubahan' => $id_kk_perubahan
                );

                $this->M_surat_kk_perubahan->update_data($where,$data,'tbl_permohonan_kk_perubahan');
